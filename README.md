...
- Use [React Native Rename](https://github.com/junedomingo/react-native-rename) to update project name - `$ npx react-native-rename <newName>`. This isn't full proof. Search for `desafioton` in your project folder using VSCode's search found on the left hand toolbar and replace it with name you passed to `react-native-rename` a.k.a `<newName>`. Do check the _android/app/src/main/java_ folder. It would have the `desafioton` folder. Rename the folder to your project name.
...
React Native Seed welcomes contributions to our open source project. When contributing, please follow the [Contributing](https://github.com/rashtay/DesafioTon/blob/main/CONTRIBUTING.md) guide.
...
If you run into any issues, go through the [F.A.Q.](https://github.com/rashtay/DesafioTon/blob/main/FAQ.md) file. Amongst other things, this document contains information about common issues.

## Support

- If any information is missing from the [README](https://github.com/rashtay/DesafioTon/blob/main/README.md) file, want to raise a feature request or report any bug, please create a new [issue](https://github.com/rashtay/DesafioTon/issues) with appropriate labels.

## License

For licensing information, go through [License](https://github.com/rashtay/DesafioTon/blob/main/LICENSE) file.
